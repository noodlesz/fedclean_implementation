...
if __name__ == '__main__':
    ...
    with open("constant_n_data.csv","w+") as csv_file:
        ...
        my_writer.writerow((0,acc_train,acc_test))
        my_writer.writerow((1,acc_train1,acc_test1))
        my_writer.writerow((5,acc_train5,acc_test5))
        my_writer.writerow((10,acc_train10,acc_test10))
        my_writer.writerow((15,acc_train15,acc_test15))
        my_writer.writerow((20,acc_train20,acc_test20))
        my_writer.writerow((25,acc_train25,acc_test25))
        my_writer.writerow((30,acc_train30,acc_test30))
