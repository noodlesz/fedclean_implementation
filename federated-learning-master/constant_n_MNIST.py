...
if __name__ == '__main__':
    ...
    for iter in range(args.epochs):
        ...
        for idx in idxs_users:
            ...
            if idx in fixed_agent_5:
                malicious_count[5]+=1
                selection_count_5[idx]+=1
                if (selection_count_5[idx]%5)==0:
                    updates_recorded_mapping_5[idx]=False
            ...
            if idx in fixed_agent_10:
                ...
                selection_count_10[idx]+=1
                if (selection_count_10[idx]%5)==0:
                    updates_recorded_mapping_10[idx]=False
            ...
            if idx in fixed_agent_15:
                ...
                selection_count_15[idx]+=1
                if (selection_count_15[idx]%5)==0:
                    updates_recorded_mapping_15[idx]=False
            ...
            if idx in fixed_agent_20:
                ...
                selection_count_20[idx]+=1
                if (selection_count_20[idx]%5)==0:
                    updates_recorded_mapping_20[idx]=False
            ...
            if idx in fixed_agent_25:
                ...
                selection_count_25[idx]+=1
                if (selection_count_25[idx]%5)==0:
                    updates_recorded_mapping_25[idx]=False
            ...
            if idx in fixed_agent_30:
                ...
                selection_count_30[idx]+=1
                if (selection_count_30[idx]%5)==0:
                    updates_recorded_mapping_30[idx]=False
    ...
    #write to csv
    with open("constant_n_data.csv","w+") as csv_file:
        my_writer = csv.writer(csv_file,delimiter=',')
        my_writer.writerow(("NUM_ATTACKS","TRAIN_ACCURACY","TEST_ACCURACY"))
        my_writer.writerow((0,str(acc_train),str(acc_test)))
        my_writer.writerow((1,str(acc_train1),str(acc_test1)))
        my_writer.writerow((5,str(acc_train5),str(acc_test5)))
        my_writer.writerow((10,str(acc_train10),str(acc_test10)))
        my_writer.writerow((15,str(acc_train15),str(acc_test15)))
        my_writer.writerow((20,str(acc_train20),str(acc_test20)))
        my_writer.writerow((25,str(acc_train25),str(acc_test25)))
        my_writer.writerow((30,str(acc_train30),str(acc_test30)))
