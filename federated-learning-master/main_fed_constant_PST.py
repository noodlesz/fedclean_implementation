...
if __name__ == '__main__':
    ...
    if args.model == 'cnn' and args.dataset == 'cifar':
        ...
        trusted_glob = CNNMnist(args=args).to(args.device)
        trusted_malicious_glob = CNNMnist(args=args).to(args.device)
    ...
    #bad_agents.append(fixed_agent_1)
    ...
    #bad_agents = bad_agents + fixed_agent_5
    ...
    #bad_agents = bad_agents + fixed_agent_10
    ...
    #bad_agents = bad_agents + fixed_agent_15
    ...
    #bad_agents = bad_agents + fixed_agent_20
    ...
    #bad_agents = bad_agents + fixed_agent_25
    ...
    #bad_agents = bad_agents + fixed_agent_30
    ...
    #remove duplicates from bad_agents
    #bad_agents = list(set(bad_agents))

    #selecting a trusted user which is NOT BAD.
    #good_agent = None
    ...
    def trustedPlusMaliciousModel(w_trusted,loss_trusted,w_malicious,loss_malicious,trusted_loss_average):
        ...
        #w_trusted,loss_trusted = local.train_filter(net=copy.deepcopy(trusted_glob).to(args.device))
        ...
        if trusted_malicious_loss_avg <= (trusted_loss_average + (0.03*trusted_loss_average)):
            #print("GOOD")
