#DATA STRUCTURE: HASHMAP => KEYS are unique agent names, VALUES is a list in the following manner: ["ACCOUNT_ADDRESS","PRIVATE_KEY","REP_SCORE(if needed)"]

#NOTE: THESE ARE NOT WHITELISTED CLIENTS. A SCRIPT NEEDS TO BE RUN BY ABHISHEK TO WHITELIST CLIENTS FROM THESE.i
